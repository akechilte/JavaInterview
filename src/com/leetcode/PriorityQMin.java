package com.hackerrank.ds.priorityQ;

import java.util.Arrays;

/**
 * Created by mbiswas on 8/2/18.
 */
public class PriorityQMin {
    ...
    public PriorityQMin(int maxSize) {
    ...
    public void push(int val) {
        ...
        while (pos > 0) {
            // Get the child and compare the values
    ...
    public static void main(String[] args) {
        PriorityQMin pq = new PriorityQMin(5);
        pq.push(8);
        pq.push(3);
        pq.push(5);
        pq.push(15);
