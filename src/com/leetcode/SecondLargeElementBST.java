...
// YouTube : https://www.youtube.com/watch?v=OKAEDMCwhNI
public class SecondLargeElementBST {
    ...
    // A binary tree node
     class Node {
        ...
        {
            SecondLargeElementBST tree = new SecondLargeElementBST();
